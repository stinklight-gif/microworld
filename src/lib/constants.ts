...
export const REPRODUCTION_THRESHOLDS = {
  ...
  min_food: 5,       // Must have > 5 food after consumption
  min_shelter: 3,    // Must have > 3 shelter after consumption
  parent_surplus_share: 0.4, // parent gives 40% of surplus to child
};
